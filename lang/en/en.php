...
return [
    ...
    'find_tutors' => [
        ...
        'post_nudge' => 'Post a tuition requirement to see tutors matched to you.',
        'reason_in_area' => 'In your area',
        'reason_subjects' => 'Matches :count subjects',
        'reason_subject' => 'Matches 1 subject',
        'reason_class' => 'Teaches your class',
    ...
    'tuition_jobs' => [
        ...
        'tutor_suffix' => ':gender Tutor',
        'salary_negotiable' => 'Negotiable',
        'label_location' => 'Area / Location',
        'label_class' => 'Class',
        'label_group' => 'Academic Group',
        'student_level_heading' => 'Student Level',
        'student_level_hint' => 'Pick a broad level, or narrow to a specific class.',
        'label_gender' => 'Tutor Gender Preference',
        'label_level' => 'Academic Level',
        'label_min_salary' => 'Minimum Budget',
        'label_max_days' => 'Max Days / Week',
        'group_disabled_hint' => 'Select Group (class 9-12 only)',
        'applying_filters' => 'Applying filters...',
        'showing_results_for' => 'Showing results for:',
        'more_count' => '+:count more',
        'no_posts_title' => 'No tuition posts found',
        'empty_clear' => 'Clear all filters',
        'posted_just_now' => 'Posted just now',
        'posted_minutes' => 'Posted :count min ago',
        'posted_hours' => 'Posted :count hr ago',
        'posted_days' => 'Posted :count days ago',
        'best_matches_heading' => 'Best Matches for you',
        'best_matches_subheading' => 'Tuition posts that fit your subjects and preferred areas.',
        'tab_best' => 'Best matches',
        'tab_recent' => 'Most recent',
        'tab_saved' => 'Saved jobs',
        'saved_empty' => "You haven't saved any jobs yet.",
        'saved_empty_hint' => 'Tap the heart on any tuition post to save it for later.',
        'save' => 'Save job',
        'unsave' => 'Remove from saved',
        'reason_in_area' => 'In your area',
        'reason_subjects' => 'Matches :count subjects',
        'reason_subject' => 'Matches 1 subject',
        'reason_class' => 'Teaches this class',
    ],
    'show' => [
